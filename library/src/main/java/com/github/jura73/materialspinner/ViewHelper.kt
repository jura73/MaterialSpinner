...
internal object ViewHelper {
    fun setupToolbar(dialog: Dialog, filter: Filter) {
        ...
        toolbar.navigationIcon = dialog.context.resources.getDrawable(R.drawable.ic_arrow_back_white_24dp)
        toolbar.setNavigationOnClickListener { dialog.onBackPressed() }

        val searchView = toolbar.menu.findItem(R.id.action_search)
