...
public class ListOneSelectorView<T> extends ListSelectorView<T> {
    ...
    public ListOneSelectorView(Context context) {
        super(context);
    }

    public ListOneSelectorView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ListOneSelectorView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
            ...
            ListDialog<T> dialog = new ListDialog<>(getContext(), mArrayList, new OnItemSelectedListener<T>() {
                ...
                public void onItemSelected(@NonNull T item, @NonNull View view, int position) {
                    ...
                    if (mOnItemSelectedListener != null) {
                        mOnItemSelectedListener.onItemSelected(item, ListOneSelectorView.this, position);
                    }
